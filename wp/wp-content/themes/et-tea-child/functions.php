 ...
 * Genesis ET Tea.
 *
 * This file adds functions to the Genesis ET Tea Theme.
 *
 * @package Genesis ET Tea
 * @author  StudioPress
 * @license GPL-2.0+
...
function genesis_sample_enqueue_scripts_styles() {
	...
	wp_enqueue_style( 'genesis-sample-fonts', '//fonts.googleapis.com/css?family=Gabriela:400,600,700', array(), CHILD_THEME_VERSION );
    
    wp_enqueue_style( 'genesis-sample-fontss', 'https://fonts.googleapis.com/css?family=Crimson Text', array(), CHILD_THEME_VERSION );
...
function sp_custom_footer() {
    ?>
    <div class="et-footer">
        <p class="et-footer-left">Designed by <a target="_blank" href="https://enginetemplates.com/">Enginetemplates.com</a>  - Powered by <a target="_blank" href="https://wordpress.org/">Wordpress</a>
        </p>
        <p style="padding-top: 10px;"><a target="_blank" href="https://enginetemplates.com/" title="Best Free Joomla templates and Wordpress themes by Enginetemplates">Best Free Joomla templates and Wordpress themes by Enginetemplates</a> <a style="border: 2px solid #ccc;padding: 5px;" target="_blank" href="https://enginetemplates.com/themes/et-tea-free-responsive-tea-wordpress-theme/" title="Get PRO version, access all features like demo">Get PRO version here</a></p>
    </div>
